//
//  AboutTruckTableViewController.swift
//  Truckers
//
//  Created by Ala'a Amerkani on 10/28/17.
...
class AboutTruckTableViewController: UITableViewController, MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, annotationView view: MKAnnotationView, calloutAccessoryControlTapped control: UIControl) {
        if control == view.rightCalloutAccessoryView {
            ...
            let customURL = "comgooglemaps://?saddr=&daddr=\(annotation.coordinate.latitude),\(annotation.coordinate.longitude)&directionsmode=driving"
